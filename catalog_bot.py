...
books = {
    ...
    "Отпуск с огоньком": (138, 177), 
    "Весенняя почта": (178, 185),
    "Помнить будущее": (209, 220),
    "Пчелиный рой": (223, 249),
    "Черноморский призрак": (250, 263),
    "Следствие ведёт медиум": (264, 274),
    "100 новых смешных сценок": (275, 300)
}
