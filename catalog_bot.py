...
books = {
    ...
    "Чернокнижник": (125, 137),
    "Агулова Ирина, Саввина Яра - Отпуск с огоньком": (138, 177), 
    "Весенняя почта": (178, 185),
    "Гончаров Сергей - Помнить будущее": (209, 220),
    "Ли Рия - Пчелиный рой": (223, 249),
    "Лысак Сергей - Некомбатант 04. Черноморский призрак": (250, 263),
    "Львова Лариса - Следствие ведёт медиум": (264, 274),
    "Палёк Олег - 100 новых смешных сценок": (275, 300)
}

movies_range = (7, 33)  # фильмы идут подряд
